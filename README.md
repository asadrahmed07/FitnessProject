...
For Frontend I am using React, I have also included a registry Eureka Server and for a AI Generated opinion on Workouts we are also communicating to Google Gemini open API. 
